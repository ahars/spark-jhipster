...
var jhipsterSandboxApp = angular.module('jhipsterSandboxApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'jhipsterSandboxAppUtils', 'pascalprecht.translate', 'truncate']);
